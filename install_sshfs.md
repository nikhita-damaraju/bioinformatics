...
1. Install HomeBrew via `$ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)"`. <a href = "https://mac.install.guide/homebrew/3">Source</a>
